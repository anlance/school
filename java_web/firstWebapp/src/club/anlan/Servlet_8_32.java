...
@WebServlet(name = "Servlet_8_32")
public class Servlet_8_32 extends javax.servlet.http.HttpServlet {
        ...
        try {
            ...
            while(rs.next()){
                ...
                out.write("<tr>" +
                        ...
                        "<td>" +name+"</td>"+
                        "<td>" +price+"</td>" +
                        "<td><a href ='Servlet_8_32?id="+id+"'>从购物车中删除</a></td>"+
                        "</tr>");
            }
            out.write("</table>");
            conn.close();
    ...
    protected void MySession(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        out.write("<a href ='/8_3.jsp'>查询书籍</a>");
    }
}
